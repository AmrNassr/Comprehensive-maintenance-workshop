 ...
 * @author amnassar
 */
public final class done extends javax.swing.JInternalFrame {
    ...
    public done(String type,String username , String oldnew , String section) throws ParseException {
        initComponents();
          clear();
          typee=type;
        usernamee=username;
...
headerLabel.setHorizontalAlignment(JLabel.CENTER);
    ...
    private void initComponents() {
        ...
        jLabel20.setText("طلبات الاصلاح المكتملة");
...
public void tablelord()
{
    ...
    {
        try {
           String sqll = "SELECT * FROM karem.repaireorder  where statuss = 'done'  order by id";
    ...
    {
    try {
           String sqll = "SELECT * FROM karem.repaireorder  where statuss = 'done' and username = '"+usernamee+"' order by id";
              pst=(PreparedStatement) DBConnect.appcon.prepareStatement(sqll);
            rs=pst.executeQuery();
            DefaultTableModel model =(DefaultTableModel)tdetails.getModel(); 
                model.setRowCount(0);
