 ...
 * @author amnassar
 */
public final class norespond extends javax.swing.JInternalFrame {
    ...
    public norespond(String type,String username , String oldnew , String section ) throws ParseException {
        initComponents();
          clear();
          typee=type;
        usernamee=username;
...
headerLabel.setHorizontalAlignment(JLabel.CENTER);
    ...
    private void initComponents() {
        ...
        if (tdetails.getColumnModel().getColumnCount() > 0) {
            tdetails.getColumnModel().getColumn(1).setMinWidth(60);
            tdetails.getColumnModel().getColumn(1).setPreferredWidth(60);
            tdetails.getColumnModel().getColumn(1).setMaxWidth(60);
        ...
        jPanel10.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 950, 410));

        jLabel20.setBackground(new java.awt.Color(255, 255, 255));
        jLabel20.setFont(new java.awt.Font("Arial", 1, 36)); // NOI18N
        jLabel20.setText("لم يتم الرد ");
        jPanel10.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 20, 440, 60));
        ...
        jPanel10.add(delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 550, 170, 40));
...
public void tablelord()
{
    ...
    {
        try {
           String sqll = "SELECT * FROM karem.repaireorder where statuss in ('draft' , 'resend') and datee not in "
    ...
    try {
           String sqll = "SELECT * FROM karem.repaireorder where statuss in ('draft' , 'resend') and datee not in "
                   ...
                   + "and username='"+usernamee+"' order by id ";
              pst=(PreparedStatement) DBConnect.appcon.prepareStatement(sqll);
            rs=pst.executeQuery();
            DefaultTableModel model =(DefaultTableModel)tdetails.getModel(); 
                model.setRowCount(0);
