...
public class repaireorderdetails extends javax.swing.JFrame {
  Connection con ;  
    ...
    String typee=cmtype.getSelectedItem().toString();
     InputStream in=null;
      try {
          ...
          in = this.getClass().getResourceAsStream("/reports/repaireorderdetails.jasper");
...
public void msroffat()
   {
        try {
             String sql="SELECT code  FROM karem.item ";
