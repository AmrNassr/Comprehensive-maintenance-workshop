...
public class numberofdays extends javax.swing.JFrame {
         ...
         || dayy == 5 || dayy == 6 || dayy == 7 || dayy == 8 || dayy == 9 )
 {
    ...
    private void initComponents() {
        ...
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 160, 120, 40));
    ...
    String to=year2.getText()+"-"+month2.getText()+"-"+day2.getText();
     InputStream in=null;
      try {
          ...
          in = this.getClass().getResourceAsStream("/reports/numberodays.jasper");
