 ...
 * @author amnassar
 */
public final class finished extends javax.swing.JInternalFrame {
    ...
    public finished(String type,String username , String oldnew , String section) throws ParseException {
        initComponents();
          clear();
          typee=type;
        usernamee=username;
...
headerLabel.setHorizontalAlignment(JLabel.CENTER);
    ...
    private void initComponents() {
        ...
        jPanel10.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 940, 410));
        ...
        jPanel10.add(delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 510, 170, 40));
        ...
        jPanel10.add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 650, -1, -1));

        code.setText("jLabel1");
        jPanel10.add(code, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 650, -1, -1));
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        {
            try {
                String sql1 = "UPDATE karem.repaireorder SET statuss='finished' where id = '"+serialid.getText()+"'";
                ...
                String sql = "INSERT INTO karem.logs (eqname,codee,seriall,datee,fulldate,username,statuss)"
                        + " VALUES ('"+name.getText()+"','"+code.getText()+"','"+serial.getText()+"','"+datee+"','"+fulldatee+"','"+usernamee+"','finished')";
        ...
        else
        {
                    ...
                    JOptionPane.showMessageDialog(rootPane, "اختر المعدة");
        }
