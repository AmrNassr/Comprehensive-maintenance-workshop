...
public final class follow extends javax.swing.JInternalFrame {
    ...
    public follow(String type,String username , String oldnew , String section) throws ParseException {
        initComponents();
          clear();
          typee=type;
        usernamee=username;
...
headerLabel.setHorizontalAlignment(JLabel.CENTER);
    ...
    private void initComponents() {
        ...
        jLabel20.setText("طلبات الاصلاح لم يتم استلامها");
        jPanel10.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 20, 440, 60));
        ...
        jPanel10.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 940, 410));
        ...
        jPanel10.add(delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 540, 170, 40));
...
public void tablelord()
{
    ...
    {
    try {
           String sqll = "SELECT * FROM karem.repaireorder  where( statuss in ('resend','draft') ) and username = '"+usernamee+"' order by id";
              pst=(PreparedStatement) DBConnect.appcon.prepareStatement(sqll);
            rs=pst.executeQuery();
            DefaultTableModel model =(DefaultTableModel)tdetails.getModel(); 
                model.setRowCount(0);
